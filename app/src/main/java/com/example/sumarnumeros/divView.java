...
public class divView extends AppCompatActivity {
    private Button backBtn, nextBtn, divBtn;
...
//        Conexion del display tipo texto
        rstView = findViewById(R.id.textView3);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                mPlayer.start();
                Intent backView = new Intent(divView.this, mainView.class);
        ...
        nextBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                mPlayer.start();
                Intent nextView = new Intent(divView.this, sumView.class);
